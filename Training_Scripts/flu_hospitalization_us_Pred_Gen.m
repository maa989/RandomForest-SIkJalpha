...
%%
%Prepare matrix to collect coverage information
%-------------------------
...
days = maxt;%172;%maxt;
wks = (days-11)/7 - 1; %total weeks that have passed excluding initial GT data
predT = nan(120,56,1);
...
predILI = table;
for i=1:56
    predILI = [predILI; array2table(squeeze(predT(:,i,:))')];
end
...
%%
save flu_hospitalization_T-New_predictors.mat H;
