...
zero_date = datetime(2020, 1, 23);%datetime(2021, 9, 1);
...
days = maxt;%172;%maxt;
load COVID_hospitalization_T-Old_predictors.mat
...
%prepare predictors
predT= predT(:,:,2:end);
save COVID_hospitalization_T-Old_predictors.mat predT
first = nan(56,11,4);
...
%%
save COVID_hospitalization_T-New_predictors.mat H;
